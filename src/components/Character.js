...
`}
    ...
    <div id="wanted" className="slider-container w-full h-auto bg-cover bg-center mx-auto px-4 md:px-8 lg:px-32 pt-8" style={{
                  backgroundImage: "url(/bg-screen2.png)",
                  backgroundSize: 'cover', // 画像がコンテナの幅いっぱいになるように変更
                  backgroundPosition: 'center', // 画像を中央に配置
                  backgroundRepeat: 'no-repeat', // 画像を繰り返さない
                }}>
      <div className=" section2title flex justify-center items-start " style={{ height: 'calc(100vh / 5)' }}>
        <div>
         <h1 style={{fontSize: '5em', color: 'white', fontWeight: 'bold'}}>WANTED</h1>
        </div>
      </div>
      <div className=" section2title flex justify-center items-start mb-8" style={{ height: 'calc(100vh / 10)' }}>
        <div>
      ...
      <div className=" section2title flex justify-center items-start" style={{ height: 'calc(100vh / 6)' }}>
        <div>
